modifier_item_standef_talisman = class({})

function modifier_item_standef_talisman:IsHidden()
	return true
end

function modifier_item_standef_talisman:GetAttributes()
	return MODIFIER_ATTRIBUTE_NONE 
end

function modifier_item_standef_talisman:DeclareFunctions()
...
function modifier_item_standef_talisman:GetModifierBonusStats_Intellect()
	return self:GetAbility():GetSpecialValueFor("bonus_intelligence")
end

function modifier_item_standef_talisman:GetModifierConstantManaRegen()
	return self:GetAbility():GetSpecialValueFor("bonus_mana_regen")
end

function modifier_item_standef_talisman:OnAbilityExecuted(eventInfo)
...
function modifier_item_standef_talisman:OnDeath(eventInfo)
