modifier_item_standef_motivatingmekanism_aura = class({})

function modifier_item_standef_motivatingmekanism_aura:IsHidden()
	return false
end

function modifier_item_standef_motivatingmekanism_aura:DeclareFunctions()
...
function modifier_item_standef_motivatingmekanism_aura:GetModifierPhysicalArmorBonus()
	return self:GetAbility():GetSpecialValueFor("aura_armor")
end

function modifier_item_standef_motivatingmekanism_aura:GetModifierConstantHealthRegen()
	return self:GetAbility():GetSpecialValueFor("aura_health_regen")
end

function modifier_item_standef_motivatingmekanism_aura:GetModifierExtraHealthPercentage()
	return self:GetAbility():GetSpecialValueFor("aura_health_pct")
end

function modifier_item_standef_motivatingmekanism_aura:OnAttackLanded(eventInfo)
